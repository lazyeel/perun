...
| 2026-09-24 | IPA replication re-measured end to end: 31 real packages pulled live (32.3 GB), every one rc=0 and every rebuilt archive read back clean, zero errors. Extremes: PUBG Mobile 3.89 GB (3 888 594 339 B), Wargaming Tanks Blitz 47 007 zip entries in one archive (3.14 GB / 2.92 GiB), replicated at 1.0-1.1 GiB peak RSS (wait4/ru_maxrss, n=3) against 49.6 MiB for a 47 MB package. The earlier `ipa.rs` note said "3.14 GiB" for Tanks Blitz — a decimal-GB figure mislabelled as binary — and claimed "under tens of MiB" of RSS, which measurement contradicts; both corrected. |
