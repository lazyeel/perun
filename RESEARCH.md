...
| 2026-09-22 | Watchpoint tracing (`watch`, mprotect + SIGSEGV first-touch attribution with register dump) + live-spim-inside-inner negative + byte0 sweep 256/256: header content never discriminates; valid header unforgeable offline. |
