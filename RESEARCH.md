...
5. A `perun scaffold` command to generate a ready-to-fill shim stub from a trap report. (Still unimplemented; the trap message no longer names it — it reports `no implementation (unresolved import; shim missing)`.)
